				...
				<fieldset class="clear">
						...
						<label class="small left" for="landingPageRecordNum">Default Landing Page<br />
								<select size="1" name="landingPageRecordNum" id="landingPageRecordNum">
										...
										<?foreach($sectionPages as $contentRecordNum => $contentTitle):?>
										<option value="<?=$contentRecordNum;?>" <?php if ($landingPageRecordNum == $contentRecordNum) {echo " selected=\"selected\"";} ?>><?=$contentTitle;?></option>
										<?endforeach;?>
								</select>
						</label>
